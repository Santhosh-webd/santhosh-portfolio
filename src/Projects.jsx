                ...
                <div className="portfolio-container final-container">
                    <div className="portfolio-box">
                        <div className="portfolio-detail active">
                            ...
                            <div className="liveandgitdiv">
                                <a data-aos="flip-left" href="https://littlereviewmain.netlify.app"><button className="liveproject">Live Project</button></a>
                            <div className="live-github">
                                <a data-aos="flip-left" href="https://github.com/Santhosh-webd/mern-crud-main"><i class='bx bxl-github' ></i><span>Github Repostiory</span></a>
                            </div>
                            </div>
                        </div>
                    </div>
